    ...
    <div class="left_menu" id="left_menu">
        ...
        <div class="menu_container">
            <el-scrollbar class="menu_list" >
                <div class="menu" v-for="menu in UserViewMenu"><el-button class="menu_button" :id="menu.id" @click="setPage(menu.id)"><svg xmlns="http://www.w3.org/2000/svg" :width="menu.icon.width" :height="menu.icon.height" :viewBox="menu.icon.viewBox" fill="none"><path fill-rule="evenodd" style="fill:#646438" :opacity="menu.icon.opacity" :d="menu.icon.d"></path></svg><div class="title-div">{{menu.title}}</div></el-button></div>
            </el-scrollbar>
        </div>
    </div>
    <div class="main">
